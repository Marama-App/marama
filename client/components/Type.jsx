        ...
        <div className='page-section'>
          ...
          {this.props.typeDetails.help.map(help => (
            <div key={help.id}>
              ...
              <div><p>Are you eligible for an Iwi grant?</p><Link to='/iwi-grants'><button>Iwi Grants</button></Link></div>
              <div><h2>Pasifika Students</h2></div>
              <div><p>Find out if you are eligible for Pasifika Education grant</p><Link to='/pasifika-grants'><button>Pasifika Grants</button></Link></div>
            </div>
          ))}
        </div>
      </div>
